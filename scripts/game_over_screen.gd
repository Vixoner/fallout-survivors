...
func _build_ui():
	...
	ov_tween.tween_property(overlay, "color:a", 0.88, 0.4)
	...
	ct_tween.tween_interval(0.3)
	ct_tween.tween_property(center, "modulate:a", 1.0, 0.4)
	...
	var title = _label("// GAME OVER //", 46, C_BRIGHT)
	title.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	vbox.add_child(title)

	var subtitle = _label("ZOSTAŁEŚ POKONANY", 15, C_MID)
